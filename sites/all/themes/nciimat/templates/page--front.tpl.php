...
<div role="document" class="page">
  ...
  <?php endif; ?>
    ...
    <div class="large-6 main columns main-content-wrapper">
    ...
    <?php if (!empty($page['sidebar_first'])): ?>
      <aside role="complementary" class="large-6 sidebar-first columns sidebar">
        <?php print render($page['sidebar_first']); ?>
      </aside>
    <?php endif; ?>

    <?php if (!empty($page['sidebar_second'])): ?>
      <aside role="complementary" class="large-6 sidebar-second columns sidebar">
        <?php print render($page['sidebar_second']); ?>
      </aside>
    <?php endif; ?>
    
    <?php if (!empty($page['recent_publications'])): ?>
      <div role="complementary" class="large-12 recent_publications columns bottombar">
        <?php print render($page['recent_publications']); ?>
      </div>
    <?php endif; ?>
